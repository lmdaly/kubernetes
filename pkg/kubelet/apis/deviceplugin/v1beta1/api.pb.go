...
type TopologyInfo struct {
	Node *NUMANode `protobuf:"bytes,1,opt,name=node" json:"node,omitempty"`
}
...
func (m *Device) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Topology != nil {
		...
		n3, err := m.Topology.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n3
...
func (this *TopologyInfo) String() string {
	...
	s := strings.Join([]string{`&TopologyInfo{`,
		`Node:` + strings.Replace(fmt.Sprintf("%v", this.Node), "NUMANode", "NUMANode", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
var fileDescriptorApi = []byte{
	...
	,
}
