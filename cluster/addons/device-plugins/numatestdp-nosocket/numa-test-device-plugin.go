...
func (test *testManager) discoverTestResources() error {
 	...
 	dev001 := pluginapi.Device{ID: "25102017", Health: pluginapi.Healthy}
 	dev002 := pluginapi.Device{ID: "26102017", Health: pluginapi.Healthy}
        dev003 := pluginapi.Device{ID: "27102017", Health: pluginapi.Healthy}
